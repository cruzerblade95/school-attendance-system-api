...
public class LectureCourseRepositoryImpl implements LectureCourseRepository {
    private final SpringJpaLectureCourseRepository jpaLectureCourseRepository;
    ...
    public LectureCourseEntity getByLectureIdAndCourseId(Long lId, Long cId) {
        return jpaLectureCourseRepository.findLectureCourseEntityByLectureIdAndCourseId(lId, cId)
                .orElseThrow(() -> new ResourceNotFoundException("Lecture or Course not found with lId = " + lId + " & cId = " + cId));
    }
