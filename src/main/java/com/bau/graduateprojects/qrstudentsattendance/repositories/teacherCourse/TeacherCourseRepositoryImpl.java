...
public class TeacherCourseRepositoryImpl implements TeacherCourseRepository {
    private final SpringJpaTeacherCourseRepository jpaTeacherCourseRepository;
    ...
    public TeacherCourseEntity getByTeacherIdAndCourseId(Long tId, Long cId) {
        return jpaTeacherCourseRepository.findTeacherCourseEntityByTeacherIdAndCourseId(tId, cId)
                .orElseThrow(() -> new ResourceNotFoundException("Course or Teacher not found with tId = " + tId + " & cId = " + cId));
    }
