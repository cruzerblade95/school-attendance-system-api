...
public class LectureAttendanceRepositoryImpl implements LectureAttendanceRepository {
    private final SpringJpaLectureAttendanceRepository jpaLectureAttendanceRepository;
    ...
    public List<AttendanceEntity> getAllAttendanceByLectureId(Long lId) {
        ...
        jpaLectureAttendanceRepository.findAllByLectureId(lId)
                .forEach(lectureAttendanceEntity -> {
